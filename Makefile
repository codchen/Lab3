...
#
ALL = yfs iolib.a tcreate tcreate2 tlink tls topen2 tsymlink tunlink2 writeread
...
#
YFS_OBJS = yfs.o utils.o
YFS_SRCS = yfs.c utils.c
...
#
IOLIB_OBJS = iolib.o utils.o
IOLIB_SRCS = iolib.c utils.c
